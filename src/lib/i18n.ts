...
export const translations: Record<Lang, Dict> = {
  uk: {
    nav: { events: "Події", organizer: "Організаторам", login: "Увійти", signup: "Реєстрація", dashboard: "Панель організатора", profile: "Профіль", logout: "Вийти", myEvents: "Мої події", contacts: "Контакти" },
    hero: {
  ...
  en: {
    nav: { events: "Events", organizer: "For organizers", login: "Sign in", signup: "Sign up", dashboard: "Add event", profile: "Profile", logout: "Sign out", myEvents: "My events", contacts: "Contacts" },
    hero: {
