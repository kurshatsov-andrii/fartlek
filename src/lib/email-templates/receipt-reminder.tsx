...
const ReceiptReminderEmail = ({ name, eventTitle, ticketUrl }: ReceiptReminderProps) => {
  ...
  return (
    <Html lang="uk" dir="ltr">
      ...
      <Preview>Завантажте квитанцію про оплату{eventTitle ? ` для «${eventTitle}»` : ""}</Preview>
      <Body style={main}>
...
export const template = {
  component: ReceiptReminderEmail as React.ComponentType<Record<string, unknown>>,
  subject: (data: Record<string, unknown>) =>
    data?.['eventTitle']
      ? `Завантажте квитанцію: ${String(data['eventTitle'])}`
