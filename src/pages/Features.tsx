  ...
  const organizerGroups: Group[] = isUk ? [
    {
      ...
      items: [
        ...
        { icon: Users, title: "Співорганізатори", desc: "Додавайте співорганізаторів до події — вони можуть редагувати деталі, керувати учасниками та завантажувати результати і файли." },
