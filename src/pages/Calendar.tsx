                    ...
                    <TableBody>
                      {group.rows.map((r, idx) => (
                        ...
                        >
                          ...
                          <TableCell className="text-sm text-muted-foreground">{r.location || "Україна та весь світ"}</TableCell>
                          <TableCell className="text-sm">{r.distances || "Вільна дистанція"}</TableCell>
