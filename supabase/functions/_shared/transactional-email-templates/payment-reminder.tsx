    ...
    <Html lang="uk" dir="ltr">
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={text}>
            Якщо ще <strong>не оплатили</strong> — спочатку здійсніть оплату за реквізитами організатора, а потім <strong>обов'язково завантажте квитанцію</strong> на сторінці квитка.
          </Text>
