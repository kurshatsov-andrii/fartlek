    ...
    <Html lang="uk" dir="ltr">
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={text}>
            Нагадуємо, що ваша реєстрація{eventTitle ? <> на змагання <strong>«{eventTitle}»</strong></> : ''} ще <strong>не оплачена</strong>.
          </Text>
          ...
          <Text style={text}>
            Щоб завершити реєстрацію, перейдіть на сторінку вашого квитка та натисніть кнопку <strong>«Оплатити»</strong>. Поряд із QR-кодом ви знайдете кнопку оплати.
          </Text>
          ...
          <Text style={hint}>
            Після оплати, будь ласка, <strong>завантажте квитанцію</strong> на сторінці квитка — це підтвердить вашу участь.
          </Text>
